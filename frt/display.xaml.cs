...
#pragma warning restore CS0414 // 字段“display.isshow”已被赋值，但从未使用过它的值
        ...
        private void Timer_Tick(object sender, object e)
        {
            ...
            {
                before = txtdis.Substring(0, bitetimes * linewidth);
                currentline = txtdis.Substring(bitetimes * linewidth, linewidth);
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            linewidth = (int)(1278 / txtdisplay.FontSize);
           


        }
        private void textdisplyonce(string before,string currentline,string after)
        {
            ...
            run2.Text = currentline;
            run2.Foreground = myBrush;
            Run run3 = new Run();
            run3.Text = after;
            txtdisplay.Inlines.Add(run1);
            txtdisplay.Inlines.Add(run2);
           txtdisplay.Inlines.Add(run3);
